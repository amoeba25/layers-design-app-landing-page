            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 lg:grid-cols-3">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            ...
                            <Avatar className="-ml-6 border-transparent z-10 group-hover:border-green-500 transition duration-1000">
                                <div className="size-full bg-neutral-700 rounded-full inline-flex items-center justify-center gap-1 relative">
                                    <Image
                                        src={avatar4}
                                        alt="Avatar 4"
                                        className="absolute size-full rounded-full opacity-0 group-hover:opacity-100 transition duration-1000"
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 text-center group-hover:text-white group-hover:bg-clip-text group-hover:text-transparent transition duration-1000">
                    ...
                    <FeatureCard
                        ...
                        className="col-span-1 md:col-span-2 md:col-start-2 lg:col-span-1 group"
                    >
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map(feature => (
                        <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center group">
                            ...
                            <span className="font-medium md:text-lg hover:scale-105 transition duration-500">{feature}</span>
                        </div>
                    ))}
                </div>
