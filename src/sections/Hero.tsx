...
export default function Hero() {
    ...
    useEffect(() => {
        ...
        leftPointerAnimate([
            ...
            [leftPointerScope.current, { y: [0, 15, 0], x: 0 }, { duration: 0.5, ease: 'easeIn' }]
        ]);
        ...
        rightPointerAnimate([
            ...
            [rightPointerScope.current, { y: [0, 20, 0], x: 0 }, { duration: 0.5, ease: 'easeIn' }]
        ])
    ...
    return (
        <section className="py-24 overflow-x-clip" style={{
            ...
            <div className="container relative">
                ...
                <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">Design tools should not slow you down. Layers combines powerful Features
