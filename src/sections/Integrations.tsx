            ...
            <div className="container">
                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    ...
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg ">Layers seamlessly connects with your favourite tool workflow
                            and collaborates across platforms.
                        </p>
                    </div>
                    ...
                    <div>
                        <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 overflow-hidden [mask-image: linear-gradient(to_bottom, transparent, black_10%, black_90%, transparent)] grid md:grid-cols-2 gap-4">
                            ...
                            <IntegrationsCol integrations={integrations.slice().reverse()} className="hidden md:flex" reverse />
                        </div>
                    </div>
