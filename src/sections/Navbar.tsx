...
export default function Navbar() {
    ...
    return (
        <>
                ...
                <div className="container max-w-5xl">
                    <div className="border border-white/15 rounded-[27px] md:rounded-full bg-neutral-950/70 backdrop-blur">
                        <div className="grid grid-cols-2 lg:grid-cols-3   p-2 px-4 md:pr-2 items-center ">
                            <div>
                                <Image src={logoImage} alt="" className="h-9 md:h-auto w-auto" />
                            </div>
                            ...
                            <div className="flex justify-end gap-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-menu md:hidden"
                                    ...
                                    <line x1="3" y1="18" x2="21" y2="18" className={twMerge("transition", "transition origin-left", isOpen && '-rotate-45 translate-y-1')}></line>
                                </svg>
            ...
            {/* Take up space as fixed section would not */}
